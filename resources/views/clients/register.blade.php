        ...
        <div class="mdk-header-layout__content">
            ...
            <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
                <div class="mdk-drawer-layout__content page">
                    <div style="padding-top: 50px; padding-bottom: 50px" class="container-fluid page__container">
                        <div class="card card-form">
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-8 card-form__body card-body">
                                    <form action="{{route('externalRegister')}}" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Segundo Nombre" name="second_name">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Segundo Apellido" name="second_surname">
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Teléfono de acudiente" name="guardian_phone">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="exampleInputPassword1">Parentesco de acudiente (Opcional)</label>
                                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Parentesco de acudiente" name="guardian_relationship">
                                            </div>
                                        </div>
                                        <br>

...
<head>
    ...
    <!-- Simplebar -->
    <link type="text/css" href="../../public/assets/vendor/simplebar.min.css" rel="stylesheet">

    <!-- App CSS -->
    <link type="text/css" href="../../public/assets/css/app.css" rel="stylesheet">
    <link type="text/css" href="../../public/assets/css/app.rtl.css" rel="stylesheet">

    <!-- Material Design Icons -->
    <link type="text/css" href="../../public/assets/css/vendor-material-icons.css" rel="stylesheet">
    <link type="text/css" href="../../public/assets/css/vendor-material-icons.rtl.css" rel="stylesheet">

    <!-- Font Awesome FREE Icons -->
    <link type="text/css" href="../../public/assets/css/vendor-fontawesome-free.css" rel="stylesheet">
    <link type="text/css" href="../../public/assets/css/vendor-fontawesome-free.rtl.css" rel="stylesheet">
...
<body class="layout-login">
    ...
    <div class="layout-login__form bg-white" data-simplebar>
        <div class="d-flex justify-content-center mt-2 mb-5 navbar-light">
            <a href="index.html" class="navbar-brand" style="min-width: 0">
                <img class="navbar-brand-icon" src="../../public/assets/images/stack-logo-blue.svg" width="25" alt="Stack">
                <span>Stack</span>
            </a>
        </div>
    ...
    <!-- Simplebar -->
    <script src="../../public/assets/vendor/simplebar.min.js"></script>
    ...
    <!-- App -->
    <script src="../../public/assets/js/toggle-check-all.js"></script>
    <script src="../../public/assets/js/check-selected-row.js"></script>
    <script src="../../public/assets/js/dropdown.js"></script>
    <script src="../../public/assets/js/sidebar-mini.js"></script>
    <script src="../../public/assets/js/app.js"></script>

    <!-- App Settings (safe to remove) -->
    <script src="../../public/assets/js/app-settings.js"></script>

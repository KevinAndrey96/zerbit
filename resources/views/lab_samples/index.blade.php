                ...
                <table class="table-responsive datatable" id="myTable">
                    ...
                    @foreach($labSamples as $labSample)
                        <tr>
                            ...
                            <td>{{$labSample->sample_type}}</td>
                            <td>{{$labSample->signature_date}}</td>
                            ...
                            <td>
                                <form method="POST" action="/lab-samples/{{$labSample->id}}">
                                    <input type="hidden" name="_method" value="DELETE">
                                    @csrf
                                    <input type="submit" class="btn btn-danger form-control" value="Eliminar">
                                </form>
                                <a href="/lab-samples-pdf/{{$labSample->id}}" class="btn btn-info form-control">Ver</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
